  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.user && result.session) {
        ...
        setSuccess(`Account created! Please check ${formData.email} to confirm your email address and complete setup.`)
  ...
  return (
    <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-purple-500/20 shadow-2xl animate-scale-in hover:border-purple-500/40 transition-all">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-white mb-2 animate-fade-in-up">Create Account</h2>
        <p className="text-gray-400 animate-fade-in-up" style={{animationDelay: '0.1s'}}>Start your 14-day free trial</p>
      </div>
